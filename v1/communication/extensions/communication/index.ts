...
import { CommunicationSocket, type WsConfig } from "./websocket";
...
const pendingPermissions = new Map<
  string,
  { resolve: (d: PermissionDecision) => void; timeout: ReturnType<typeof setTimeout> }
>();
...
export default async function communication(pi: {
