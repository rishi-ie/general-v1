...
const validTypes = new Set([
  'AGENT_CONNECTED', 'AGENT_DISCONNECTED', 'AGENT_STATE_CHANGED',
  'PERMISSION_REQUESTED', 'PERMISSION_RESOLVED', 'INTER_AGENT_MESSAGE',
  'AUTHORITY_CHANGED', 'PRESENCE_CHANGED', 'SETTINGS_PUSH_RESULT',
  'AUDIT_EVENT', 'LOG', 'INITIAL_SNAPSHOT',
  'LIST_AGENTS', 'APPROVE_PERMISSION', 'DENY_PERMISSION', 'PUSH_SETTINGS',
  'SEND_MESSAGE', 'REVOKE_AUTHORITY', 'KICK_AGENT', 'SEND_COMMAND', 'SUBSCRIBE',
]);
