...
function syncState(): void {
  updateState({ subAgents: Array.from(activeSubAgents.values()) }, {});
}

export default function commSubagentIntegration(pi: { on(event: string, cb: () => void | Promise<void>): void }): void {
  pi.on("session_start", () => {
